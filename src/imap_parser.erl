-file("/nix/store/4s1q4jrd31p7j0r8bl6my6csm356r68q-erlang-27.3/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl", 0).
...
-file("src/imap_parser.xrl", 36).


-file("/nix/store/4s1q4jrd31p7j0r8bl6my6csm356r68q-erlang-27.3/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl", 14).
...
yystate(29, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 72 ->
    yystate(21, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(29, [C|Ics], Line, Col, Tlen, _, _) when C >= 74, C =< 90 ->
    yystate(21, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(29, Ics, Line, Col, Tlen, _, _) ->
    {2,Tlen,Ics,Line,Col,29};
...
yystate(28, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 77 ->
    yystate(21, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 79, C =< 90 ->
    yystate(21, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(25, [76|Ics], Line, Col, Tlen, _, _) ->
    yystate(21, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(25, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 75 ->
    yystate(21, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(25, [C|Ics], Line, Col, Tlen, _, _) when C >= 77, C =< 90 ->
    yystate(21, Ics, Line, Col, Tlen+1, 2, Tlen);
yystate(25, Ics, Line, Col, Tlen, _, _) ->
    {2,Tlen,Ics,Line,Col,25};
yystate(24, [73|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(18, [34|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35, C =< 91 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 93 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(6, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11 ->
    yystate(10, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(1, Ics, Line, Col, Tlen, _, _) ->
    {8,Tlen,Ics,Line,Col};
yystate(0, [105|Ics], Line, Col, Tlen, Action, Alen) ->
...
-file("src/imap_parser.xrl", 19).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/1}).
-file("src/imap_parser.xrl", 20).
yyaction_1(TokenLine) ->
     { token, { break, TokenLine, break } } .

-compile({inline,yyaction_2/2}).
-file("src/imap_parser.xrl", 21).
yyaction_2(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/imap_parser.xrl", 22).
yyaction_3(TokenChars, TokenLine) ->
     { token, { identifier, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/imap_parser.xrl", 23).
yyaction_4(TokenChars, TokenLine) ->
     { token, { digit, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/1}).
-file("src/imap_parser.xrl", 24).
yyaction_5(TokenLine) ->
     { token, { null, TokenLine, nil } } .

-compile({inline,yyaction_6/2}).
-file("src/imap_parser.xrl", 25).
yyaction_6(TokenChars, TokenLine) ->
     { token, { string, TokenLine, string : trim (TokenChars, both, "\"") } } .

-compile({inline,yyaction_7/2}).
-file("src/imap_parser.xrl", 26).
yyaction_7(TokenChars, TokenLine) ->
     { token, { open_paren, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_8/2}).
-file("src/imap_parser.xrl", 27).
yyaction_8(TokenChars, TokenLine) ->
     { token, { close_paren, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_9/2}).
-file("src/imap_parser.xrl", 28).
yyaction_9(TokenChars, TokenLine) ->
     { token, { open_square, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_10/2}).
-file("src/imap_parser.xrl", 29).
yyaction_10(TokenChars, TokenLine) ->
     { token, { close_square, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_11/2}).
-file("src/imap_parser.xrl", 30).
yyaction_11(TokenChars, TokenLine) ->
     { token, { asterisk, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_12/2}).
-file("src/imap_parser.xrl", 31).
yyaction_12(TokenChars, TokenLine) ->
     { token, { plus, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_13/2}).
-file("src/imap_parser.xrl", 32).
yyaction_13(TokenChars, TokenLine) ->
     { token, { equal, TokenLine, list_to_atom (TokenChars) } } .
-file("/nix/store/4s1q4jrd31p7j0r8bl6my6csm356r68q-erlang-27.3/lib/erlang/lib/parsetools-2.6/include/leexinc.hrl", 344).
